// Implementation file for course
/***************************************************************
* The implementation file gives the definitions of all private * and public member functions.
***************************************************************/
#include "course.h"
#include <iomanip>
#include <cmath>
...
* number and the name of the input file containing scores. * The constructor then opens the input file and creates
* an array in the heap. The rest of the job is done by helper * functions that set the scores, the grades, the average and * deviations, and prints the results.
***************************************************************/
...
/***************************************************************
* The destructor is responsible for deleting the array created * in the heap using the corresponding pointer. It also closes * the input file opened by the constructor.
***************************************************************/
Course::~Course() {
    delete [] students;
    inputFile.close();
...
/***************************************************************
* The getInput function is responsible for reading the input * file containg the identity and score of students
***************************************************************/
...
/***************************************************************
* The getGrades function uses the score for each student and * changes it to the grade using an array of chars.
***************************************************************/
...
/***************************************************************
* The setAverage function processes scores in the array and * creates the average for the class.
***************************************************************/
...
/***************************************************************
* The setDeviation function reprocesses the scores to determine * the deviation of each student's score from the average.
***************************************************************/
